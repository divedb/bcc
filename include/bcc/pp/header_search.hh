...
///
/// Mirrors the resolution rules of Clang's HeaderSearch at a small scale:
...
///
/// An absolute filename bypasses the search list entirely.
class HeaderSearch {
 public:
 ...
 private:
  ...
  std::unordered_map<const FileEntry*, HeaderFileInfo> file_info_;
};
